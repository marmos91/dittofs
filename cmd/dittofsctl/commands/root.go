// Package commands implements the CLI commands for dittofsctl client.
package commands
...
import (
	...
	usercmd "github.com/marmos91/dittofs/cmd/dittofsctl/commands/user"
...
var rootCmd = &cobra.Command{
	...
	Long: `dittofsctl is the command-line client for managing DittoFS servers remotely.

Use this tool to manage users, groups, shares, stores, and server settings
through the DittoFS REST API.

Use "dittofsctl [command] --help" for more information about a command.`,
	SilenceUsage:  true,
	SilenceErrors: true,
