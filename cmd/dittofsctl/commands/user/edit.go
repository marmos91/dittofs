...
Examples:
  ...
  dittofsctl user edit alice --email alice@newdomain.com

  # Update role to admin
  dittofsctl user edit alice --role admin

  # Disable user
  dittofsctl user edit alice --enabled false

  # Update multiple fields
  dittofsctl user edit alice --email alice@example.com --groups editors,admins

  # Update UID
  dittofsctl user edit alice --uid 1001`,
