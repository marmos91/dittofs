...
Examples:
  ...
  # Make share writable
  dittofsctl share edit /archive --read-only false

  # Set default permission to allow all users read-write access
  dittofsctl share edit /archive --default-permission read-write

  # Update description
  dittofsctl share edit /archive --description "New description"`,
