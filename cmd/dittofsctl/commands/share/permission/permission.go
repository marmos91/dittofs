...
Examples:
  ...
  dittofsctl share permission grant /archive --group editors --level read

  # Revoke permission from a user
  dittofsctl share permission revoke /archive --user alice

  # List permissions on a share
  dittofsctl share permission list /archive`,
}
