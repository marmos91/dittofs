...
// Delegates to MetadataService.CreateSymlink with converted attributes from client request.
// Creates symlink metadata and parent entry; returns symlink handle, attrs, and parent WCC data.
// Errors: NFS3ErrExist, NFS3ErrNotDir, NFS3ErrAcces, NFS3ErrNoSpc, NFS3ErrIO.
func (h *Handler) Symlink(
	...
	if err != nil {
		...
		if ctx.Context.Err() != nil {
			...
			if updatedDirFile, getErr := metaSvc.GetFile(ctx.Context, dirHandle); getErr == nil {
