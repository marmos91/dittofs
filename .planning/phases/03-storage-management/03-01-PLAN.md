...
Note: Metadata and payload PVCs already exist from Phase 2. This plan adds the missing cache PVC.
...
grep "PersistentVolumeClaimRetentionPolicy" internal/controller/dittoserver_controller.go
grep "RetainPersistentVolumeClaimRetentionPolicyType" internal/controller/dittoserver_controller.go
```
Build should succeed, cache VolumeClaimTemplate should exist, EmptyDir should NOT exist, PersistentVolumeClaimRetentionPolicy and RetainPersistentVolumeClaimRetentionPolicyType should both exist.
  </verify>
...
```bash
grep "PersistentVolumeClaimRetentionPolicy" k8s/dittofs-operator/internal/controller/dittoserver_controller.go
```
Should find retention policy configuration.
</verification>
