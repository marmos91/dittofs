...
grep "Env:" internal/controller/dittoserver_controller.go
```
Build should succeed, buildS3EnvVars function should exist with AWS env vars.
  </verify>
  <done>S3 credentials injected as AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_ENDPOINT_URL, AWS_REGION env vars</done>
</task>
