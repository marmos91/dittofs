...
must_haves:
  truths:
    ...
    - "NLM_LOCK acquires locks through unified lock manager"
    - "NLM_UNLOCK releases locks with idempotent semantics"
    - "NLM_CANCEL removes pending blocking lock requests"
  artifacts:
...
- Add nlmHandler *nlm_handlers.Handler field
- Initialize in NewNFSAdapter or SetRuntime
- Pass to handleNLMProcedure
  </action>
  <verify>
...
Run: `go test ./...` - all tests pass
  ...
  <done>
MetadataService has NLM lock methods. NFS adapter dispatches NLM requests to NLM handlers.
  </done>
</task>
