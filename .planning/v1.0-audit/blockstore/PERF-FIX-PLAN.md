...
1. **B2 sequential growing-file — minOff-anchored reconstruct buffer.** Allocate `[minOff, maxEnd]` instead of `[0, maxEnd]`. **PROTOTYPED + reverted 2026-05-29** — analysis recorded here so it isn't re-litigated:
