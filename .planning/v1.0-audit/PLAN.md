...
3. **Bench suite audit + refactor/redesign** — 3 docs → 1 (`docs/BENCHMARKS.md` canonical, `test/e2e/BENCHMARKS.md` merge into it). Add `bench/README.md`. Wire micro-bench gates (D-40/41/42) into CI. Re-evaluate macro-bench reproducibility for v1.0 release notes. Branch `v1.0/bench-refactor`.
