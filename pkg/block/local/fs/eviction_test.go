...
func hashBytes(data []byte) block.ContentHash {
...
func storeChunk(t *testing.T, bc *FSStore, data []byte) block.ContentHash {
	t.Helper()
	h := hashBytes(data)
...
func TestLSL08_PinMode_NeverEvicts(t *testing.T) {
	...
	bc.SetRetentionPolicy(block.RetentionPin, 0)
...
func TestLSL08_LRUSeededOnStartup(t *testing.T) {
	...
	bc2.SetRetentionPolicy(block.RetentionLRU, 0)
