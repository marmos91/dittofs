...
//     corruption.
func runColdReadInPlaceOverwrite(t *testing.T, ms metadata.Store, sharePrefix string) {
	t.Helper()
...
func runCrossFileDedupKeepAlive(t *testing.T, ms metadata.Store, sharePrefix string) {
	t.Helper()
	ctx := context.Background()
