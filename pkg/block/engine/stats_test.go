...
// CAS-path Pending FileChunk (non-zero Hash, no LocalPath / BlockStoreKey) is
...
func TestGetStats_PopulateBlockCounts_CASPendingCountedAsLocal(t *testing.T) {
	...
	// Register the payload so ListFiles returns it and ListFileChunks is called.
