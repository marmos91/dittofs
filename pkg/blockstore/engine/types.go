...
type SyncerConfig struct {
	...
	// Phase 11 Plan 02 (D-14/D-25) — CAS upload-path knobs. The
	...
	//
	// Phase 19 D-23: ClaimBatchSize removed — the field was set/defaulted
	// but never read by the syncer claim path; the Phase 18 D-16
