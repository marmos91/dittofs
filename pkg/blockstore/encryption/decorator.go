...
func (d *EncryptedRemote) Put(ctx context.Context, hash blockstore.ContentHash, data []byte) error {
...
func (d *EncryptedRemote) Get(ctx context.Context, hash blockstore.ContentHash) ([]byte, error) {
...
func (d *EncryptedRemote) GetRange(ctx context.Context, hash blockstore.ContentHash, offset, length int64) ([]byte, error) {
	if length <= 0 {
...
func (d *EncryptedRemote) Has(ctx context.Context, hash blockstore.ContentHash) (bool, error) {
...
func (d *EncryptedRemote) Head(ctx context.Context, hash blockstore.ContentHash) (blockstore.Meta, error) {
...
func (d *EncryptedRemote) Walk(ctx context.Context, fn func(hash blockstore.ContentHash, meta blockstore.Meta) error) error {
...
func (d *EncryptedRemote) plaintextSizeFor(ctx context.Context, hash blockstore.ContentHash, wireSize int64) (int64, error) {
...
func (d *EncryptedRemote) Delete(ctx context.Context, hash blockstore.ContentHash) error {
...
func (d *EncryptedRemote) ReadBlockVerified(ctx context.Context, hash blockstore.ContentHash, expected blockstore.ContentHash) ([]byte, error) {
...
// or a stale policy.
func (d *EncryptedRemote) decrypt(ctx context.Context, hash blockstore.ContentHash, raw []byte) ([]byte, error) {
...
var (
	_ blockstore.BlockStore = (*EncryptedRemote)(nil)
