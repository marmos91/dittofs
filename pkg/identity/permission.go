// Package identity provides user and group management for DittoFS.
//
// This package implements a NAS-like user management system that supports
// both NFS (UID/GID) and SMB (username/password) authentication models.
// Users and groups can have share-level permissions that control access
// to DittoFS shares.
package identity
