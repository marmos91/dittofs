// Block-record support for the SQLite metadata store. Nothing dialect-specific
...
// through PoolPath, which also carries the two writes that need a transaction
// of their own (CommitBlock and DecrLiveChunkCount).
//
