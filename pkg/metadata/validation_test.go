...
func TestValidateName(t *testing.T) {
	...
	tests := []struct {
		...
		{"slash", "a/b", ErrInvalidArgument},
		{"leading slash", "/etc", ErrInvalidArgument},
		{"parent traversal", "../x", ErrInvalidArgument},
		{"embedded NUL", "a\x00b", ErrInvalidArgument},
		{"valid simple", "file.txt", 0},
		{"valid colon (slash only rejected)", "a:b", 0},
		{"valid backslash (slash only rejected)", "a\\b", 0},
